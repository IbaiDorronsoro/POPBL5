		...
		<div class="card-body">
			<table>
				...
				<tbody>
					...
					<tr>
						<td><a href="${basePath}/user/${user.userId}">${user.userId}</a></td>
						<td>${user.username}</td>
						<!-- password shouldn't be shown -->
						...
						<td><a class="button" href="${basePath}/user/${user.userId}/edit"><fmt:message key="edit"/></a></td>
						<td><a class="button" href="${basePath}/user/${user.userId}/delete"><fmt:message key="delete"/></a></td>
						</c:when>
						<c:otherwise>
						<td>-</td><td>-</td>
						</c:otherwise>
