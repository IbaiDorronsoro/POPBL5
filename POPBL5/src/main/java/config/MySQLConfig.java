...
public class MySQLConfig {
  /*
   * This is not the best policy to create connections, but is used to simplify it.
  ...
  /**
   * Singleton pattern.
   * getInstance() must be static, otherwise it cannot be called (as constructor is private).
   */
